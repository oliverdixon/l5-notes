...
% OLIVER DIXON, 2023
%
% You can download the large cover image (cover.jpg) from:
% https://www-users.york.ac.uk/~od641/l5-notes/assets/metric-spaces.{jpg,xcf}
%
...
\newcommand*\licencetext{\href{\githublink blob/\gitBranch/LICENSE}{MIT Licence}
    \ifdraft(all rights reserved on draft copies)\fi}
\urlstyle{same}
...
\ifdraft
    \fancypagestyle{plain}{
        \fancyhf{}
        \fancyhead[C]{\bfseries DRAFT/UNFINISHED}
        \fancyfoot[C]{\thepage}
    }
\fi
\makeatletter
\fancypagestyle{mainbody}{
    ...
    \ifdraft
        \fancyfoot[C]{\bfseries DRAFT/UNFINISHED}
    \fi
}
\makeatother
...
\pagenumbering{roman}
\begin{titlepage}
    \ifdraft\else\begin{tikzpicture}[remember picture, overlay]
        ...
        % JPEG optimiser can be more compressive on the majority-white regions.
...
\par\begin{itemize}
    ...
    \item Rewrite lecture summaries;
    \item Lectures:
        \begin{itemize}
            \item XII;
            \item XIII;
...
\begin{definition}{Completeness}{completeness}
    ...
    \captionof{figure}{\href{https://en.wikipedia.org/wiki/Bident\#In\_art}%
        {Pluto}, the Greek God of Convergence, brandishing his mathematical
        bident}
\end{definition}
