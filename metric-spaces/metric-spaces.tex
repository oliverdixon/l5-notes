...
\titleformat\section
    ...
    {#1\quad\leaders\hbox{\rule[.4ex]{1pt}{1pt}}\hfill}
...
\newcommand\lecture[4]{%
    ...
    \begin{tabular}{cc}
        \panoptostamp{#4}{#2} \\
        \bookstamp{SV}{sv-book} \\
        \bookstamp{Searcoid}{searcoid-book}
    \end{tabular}
    \vskip\baselineskip
}
...
\lecture{Introduction to the Topology of a Metric Space}
...
\begin{theorem}{Relationship between Mutual Convergence and Topological
    ...
    \begin{proof}
        ...
        \iffbackward A near-identical argument for deriving convergence in $
...
\begin{example}{The Harmonic Series Sequence is not
    ...
    Consider $ (\mathbb{R}, d) $ and the Harmonic series $ \sum_{n=1}^\infty 1/n
    $. Define a sequence $ \left( S_N \right)_{N=1}^\infty $, such that
    \begin{equation}
