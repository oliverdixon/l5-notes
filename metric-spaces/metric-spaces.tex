...
\usepackage{fancyhdr, anyfontsize, amsthm, mathtools, amssymb, tcolorbox,
    tocloft, titlesec, lastpage, gitinfo2, enumitem, tikz}
...
\DraftwatermarkOptions{text={Warning: Incomplete notes; do not redistribute.
    ...
    \begingroup
        ...
        \textsl{\href{\githublink}{GitHub updates}}
    \endgroup
    periodically.}
}
    ...
    \begin{minipage}{.5\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \draw (0, 0) circle[radius=1.3] node {$ A^o $} node[above left=1cm]
                {$ A^e $};
            \foreach \i in {0, 30, ..., 360} \filldraw
                (canvas polar cs:angle=\i, radius=1.15cm) circle (1pt);
        \end{tikzpicture}
    ...
    \begin{proof}
        ...
        \begin{minipage}{.5\linewidth}
            ...
            \begin{tikzpicture}
                ...
                \draw[dashed] (xpoint) circle (3cm);
                \draw (xpoint) -- ++(-30:3cm) node[anchor=south, pos=0.5,
