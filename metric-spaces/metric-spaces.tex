...
\begin{definition}{Cauchy Sequence}{cauchy-sequences}
    ...
    \begin{minipage}{.6\linewidth}
        ...
        \end{equation}
        The terms of Cauchy sequences grow arbitrarily close, and Cauchy
        sequences need not be convergent; the property of convergence requires
        the holding of the Cauchy condition and completeness in the space of the
        sequence. The notion of \emph{completeness} will be explored shortly.
    \end{minipage}\hfill
    \begin{minipage}{.35\linewidth}
        \centering
        \begin{tikzpicture}
