...
\lecture{Lecture VII}{}{
    Lecture Seven begins with an example of a space-specific equality between
    the closure of the open ball and the closed ball. We continue to demonstrate
    that a space is closed if and only if it is equal to its own closure, and
    moved to introduce the topic of limit/accumulation/cluster points, proving
    some useful related properties.
}{}
