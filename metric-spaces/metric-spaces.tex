...
\begin{theorem}{The open ball is open}{open-ball-open}
    ...
    \begin{proof}
        ...
        \begin{minipage}{.45\linewidth}
            ...
            Thus, $ z \in B(x, \epsilon) $ for all $ z \in B(y,
            \epsilon^\prime/2) $. Therefore, $ B(y, \epsilon^\prime/2) \subseteq
            B(x, \epsilon) $, and open balls are indeed open.
        \end{minipage}\hfill
        \begin{minipage}{.5\linewidth}
            \centering
            \begin{tikzpicture}
            ...
            \end{tikzpicture}
        \end{minipage}
        \par\vskip-2\parskip % Position the QED symbol
    \end{proof}
\end{theorem}
    ...
    \begin{minipage}{.35\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \foreach \radius in {1.3, 1.2, ..., .1}
                \draw[dashed] (0, 0) circle (\radius cm);
            \foreach \origin in {45, 135, 270}
                \draw[thick] (\origin:1.3cm) -- (0, 0);
