...
\begin{definition}{Open and Closed Balls}{balls}
    ...
    \begin{minipage}{.5\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \draw[->] (0, 0) -- (canvas polar cs:angle=30, radius=1cm)
                node[anchor=north, pos=0.5, xshift=2pt]{$ \epsilon $};
        \end{tikzpicture}
    ...
    \begin{minipage}{.5\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \draw[->] (0, 0) -- (canvas polar cs:angle=30, radius=1cm)
                node[anchor=north, pos=0.5, xshift=2pt]{$ \delta $};
        \end{tikzpicture}
...
\begin{definition}{Open, Closed, and Clopen Sets}{open-closed-clopen-sets}
    ...
    \begin{minipage}{.5\linewidth}
        ...
        \begin{tikzpicture}
            ...
            \draw (0, 0) circle[radius=1.3] node {$ X^o $} node[above left=1cm]
                {$ X^e $};
            \foreach \i in {0, 30, ..., 360} \filldraw
                (canvas polar cs:angle=\i, radius=1.15cm) circle (1pt);
        \end{tikzpicture}
        \captionof{figure}{An open set $ X $ does not contain its boundary
            points.}
    \end{minipage}\hfill
    \begin{minipage}{.5\linewidth}
        \centering
        \begin{tikzpicture}
            \pic at (0, 0) {squarespace};
            \draw[fill=ballfill] (0, 0) circle[radius=1.15] node {$ Y^o $}
                node[above left=1cm] {$ Y^e $};
            \foreach \i in {0, 30, ..., 360} \filldraw
                (canvas polar cs:angle=\i, radius=1.15cm) circle (1pt);
        \end{tikzpicture}
        \captionof{figure}{A closed set $ Y $ contains its boundary points.}
    \end{minipage}
\end{definition}
